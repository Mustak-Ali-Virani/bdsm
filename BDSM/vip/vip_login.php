...
<head>
  ...
  <style>
    body {
      background: url('file:///C|/xampp/htdocs/BDSM/admin_image/blood-cells.jpg') no-repeat center center fixed;
      ...
      <div class="row justify-content-center justify-content-mb-center">
        ...
        <div class="form-container">
          ...
          if (isset($_POST["login"])) {
            ...
            $sql = "SELECT * from vip_info where vip_username='$username' and vip_password='$password'";
