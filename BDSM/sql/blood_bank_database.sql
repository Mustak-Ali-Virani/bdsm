...
values("Mustak","viranibirani","123");

insert into admin_info(admin_name,admin_username,admin_password)
values("Tashdid","tashwawa","123");

insert into admin_info(admin_name,admin_username,admin_password)
values("Musaraf","uncleJi","123");

insert into admin_info(admin_name,admin_username,admin_password)
values("Gourab","gourab","123");
...
values("Dhaka,Bangladesh","bloodbank@gmail.com","2441139");
